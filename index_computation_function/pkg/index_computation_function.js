...
* @returns {any}
*/
export function calculate_financial_metrics(data) {
    try {
        const ret = wasm.calculate_financial_metrics(addBorrowedObject(data));
...
export class FinancialMetrics {
    ...
    free() {
        ...
        wasm.__wbg_financialmetrics_free(ptr);
    }
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('index_computation_function_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
